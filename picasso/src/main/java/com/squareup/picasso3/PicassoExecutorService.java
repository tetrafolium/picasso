...
/**
 * The default {@link java.util.concurrent.ExecutorService} used for new {@link
 * Picasso} instances. <p> Exists as a custom type so that we can differentiate
 * the use of defaults versus a user-supplied instance.
 */
