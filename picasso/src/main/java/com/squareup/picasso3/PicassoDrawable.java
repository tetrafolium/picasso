...
final class PicassoDrawable extends BitmapDrawable {
   ...
   */
  static void setResult(ImageView target, Context context, Result result,
    ...
    if (result instanceof Result.Bitmap) {
      ...
      PicassoDrawable drawable = new PicassoDrawable(
          context, bitmap, placeholder, loadedFrom, noFade, debugging);
   ...
   */
  static void setPlaceholder(ImageView target,
  ...
  PicassoDrawable(Context context, Bitmap bitmap,
                  @Nullable Drawable placeholder, Picasso.LoadedFrom loadedFrom,
                  boolean noFade, boolean debugging) {
