...
public final class BitmapHunterTest {
  ...
  public void nullDecodeResponseIsError() {
    ...
    BitmapHunter hunter =
        new TestableBitmapHunter(picasso, dispatcher, cache, action, null);
    hunter.run();
  ...
  public void runWithNoResultDispatchFailed() {
    Action action = mockAction(URI_KEY_1, URI_1);
    BitmapHunter hunter =
        new TestableBitmapHunter(picasso, dispatcher, cache, action);
    hunter.run();
    verify(dispatcher).dispatchFailed(hunter);
  }
  ...
  public void responseExceptionDispatchFailed() {
    Action action = mockAction(URI_KEY_1, URI_1);
    BitmapHunter hunter = new TestableBitmapHunter(
        picasso, dispatcher, cache, action, null,
  ...
  public void outOfMemoryDispatchFailed() {
    Action action = mockAction(URI_KEY_1, URI_1);
    BitmapHunter hunter =
        new OOMBitmapHunter(picasso, dispatcher, cache, action);
    hunter.run();
  ...
  public void runWithIoExceptionDispatchRetry() {
    Action action = mockAction(URI_KEY_1, URI_1);
    BitmapHunter hunter = new TestableBitmapHunter(
        picasso, dispatcher, cache, action, null, new IOException());
    hunter.run();
  ...
  public void huntDecodesWithRequestHandler() throws Exception {
    Action action = mockAction(CUSTOM_URI_KEY, CUSTOM_URI);
    BitmapHunter hunter = forRequest(mockPicasso(new CustomRequestHandler()),
  ...
  public void attachSingleRequest() {
    ...
    BitmapHunter hunter =
        new TestableBitmapHunter(picasso, dispatcher, cache, action1);
  ...
  public void forContentProviderRequest() {
    ...
    BitmapHunter hunter =
        forRequest(mockPicasso(new ContentStreamRequestHandler(context)),
                   dispatcher, cache, action);
    assertThat(hunter.requestHandler)
        .isInstanceOf(ContentStreamRequestHandler.class);
  }

  @Test
  public void forMediaStoreRequest() {
    Action action =
        mockAction(MEDIA_STORE_CONTENT_KEY_1, MEDIA_STORE_CONTENT_1_URL);
    BitmapHunter hunter =
        forRequest(mockPicasso(new MediaStoreRequestHandler(context)),
                   dispatcher, cache, action);
    assertThat(hunter.requestHandler)
  ...
  public void forContactsPhotoRequest() {
    ...
    BitmapHunter hunter =
        forRequest(mockPicasso(new ContactsPhotoRequestHandler(context)),
                   dispatcher, cache, action);
    assertThat(hunter.requestHandler)
  ...
  public void forNetworkRequest() {
    ...
    NetworkRequestHandler requestHandler =
        new NetworkRequestHandler(UNUSED_CALL_FACTORY);
    BitmapHunter hunter =
  ...
  public void forFileWithAuthorityRequest() {
    ...
    BitmapHunter hunter =
        forRequest(mockPicasso(new FileRequestHandler(context)), dispatcher,
                   cache, action);
  ...
  public void forAndroidBitmapResourceRequest() {
    ...
    BitmapHunter hunter =
        forRequest(mockPicasso(new ResourceRequestHandler(context)), dispatcher,
                   cache, action);
    assertThat(hunter.requestHandler)
  ...
  public void forAndroidXmlResourceRequest() {
    ...
    ResourceDrawableRequestHandler requestHandler =
        ResourceDrawableRequestHandler.create(context,
                                              makeLoaderWithDrawable(null));
    BitmapHunter hunter =
        forRequest(mockPicasso(requestHandler), dispatcher, cache, action);
    assertThat(hunter.requestHandler)
  ...
  public void forAssetRequest() {
    ...
    BitmapHunter hunter =
        forRequest(mockPicasso(new AssetRequestHandler(context)), dispatcher,
                   cache, action);
  ...
  public void forOverrideRequest() {
    ...
    // Must use non-mock constructor because that is where Picasso's list of
    // handlers is created.
    Picasso picasso = new Picasso(context, dispatcher, UNUSED_CALL_FACTORY,
                                  null, cache, null, NO_TRANSFORMERS, handlers,
                                  eventListeners, ARGB_8888, false, false);
    BitmapHunter hunter = forRequest(picasso, dispatcher, cache, action);
  ...
  public void rotation90WithPivotSizing() {
    Request data =
        new Request.Builder(URI_1).rotate(90, 0, 10).resize(5, 10).build();
    Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
    Bitmap result = transformResult(data, source, 0);
    ShadowBitmap shadowBitmap = shadowOf(result);
    assertThat(shadowBitmap.getCreatedFromBitmap()).isSameAs(source);
  ...
  public void exifVerticalFlip() {
    ...
    Matrix matrix = shadowBitmap.getCreatedFromMatrix();
    ShadowMatrix shadowMatrix = shadowOf(matrix);
    assertThat(shadowMatrix.getPostOperations())
        .containsExactly("scale -1.0 1.0");
  ...
  public void keepsAspectRationWhileResizingWhenDesiredWidthIs0() {
    ...
    Matrix matrix = shadowBitmap.getCreatedFromMatrix();
    ShadowMatrix shadowMatrix = shadowOf(matrix);
    assertThat(shadowMatrix.getPreOperations())
  ...
  public void centerCropResultMatchesTargetSize() {
    Request request =
        new Request.Builder(URI_1).resize(1080, 642).centerCrop().build();
  ...
  public void centerCropResultMatchesTargetSizeWhileDesiredWidthIs0() {
    Request request =
        new Request.Builder(URI_1).resize(0, 642).centerCrop().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  public void centerCropResultMatchesTargetSizeWhileDesiredHeightIs0() {
    Request request =
        new Request.Builder(URI_1).resize(1080, 0).centerCrop().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  public void centerInsideResultMatchesTargetSizeWhileDesiredWidthIs0() {
    Request request =
        new Request.Builder(URI_1).resize(0, 642).centerInside().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  public void centerInsideResultMatchesTargetSizeWhileDesiredHeightIs0() {
    Request request =
        new Request.Builder(URI_1).resize(1080, 0).centerInside().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  public void exifRotationWithManualRotation() {
    ...
    ShadowMatrix shadowMatrix = shadowOf(matrix);
    assertThat(shadowMatrix.getPreOperations()).containsExactly("rotate 90.0");
    assertThat(shadowMatrix.getSetOperations())
        .containsEntry("rotate", "-45.0");
  }
  ...
  public void pivotRotation() {
    ...
    ShadowMatrix shadowMatrix = shadowOf(matrix);
    assertThat(shadowMatrix.getSetOperations())
        .containsEntry("rotate", "-45.0 10.0 10.0");
  }
  ...
  public void centerCropTallTooSmall() {
    ...
    Request data =
        new Request.Builder(URI_1).resize(40, 40).centerCrop().build();
  ...
  public void centerCropTallTooLarge() {
    ...
    Request data =
        new Request.Builder(URI_1).resize(50, 50).centerCrop().build();
  ...
  public void centerCropWithGravityHorizontalLeft() {
    Bitmap source = Bitmap.createBitmap(20, 10, ARGB_8888);
    Request data = new Request.Builder(URI_1)
                       .resize(40, 40)
                       .centerCrop(Gravity.LEFT)
                       .build();
  ...
  public void centerInsideTallTooSmall() {
    Bitmap source = Bitmap.createBitmap(20, 10, ARGB_8888);
    Request data =
        new Request.Builder(URI_1).resize(50, 50).centerInside().build();
  ...
  public void onlyScaleDownOriginalBigger() {
    ...
    Request data =
        new Request.Builder(URI_1).resize(50, 50).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
  ...
  public void onlyScaleDownOriginalSmaller() {
    ...
    Request data =
        new Request.Builder(URI_1).resize(100, 100).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
  ...
  public void onlyScaleDownOriginalSmallerWidthIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data =
        new Request.Builder(URI_1).resize(0, 60).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
    assertThat(result).isSameAs(source);
  ...
  public void onlyScaleDownOriginalSmallerHeightIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data =
        new Request.Builder(URI_1).resize(60, 0).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
    assertThat(result).isSameAs(source);
  ...
  public void onlyScaleDownOriginalBiggerWidthIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data =
        new Request.Builder(URI_1).resize(0, 40).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
  ...
  public void onlyScaleDownOriginalBiggerHeightIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data =
        new Request.Builder(URI_1).resize(40, 0).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
  ...
  public void crashingOnTransformationThrows() {
    ...
    List<Transformation> transformations =
        Collections.singletonList(badTransformation);
    Bitmap original = Bitmap.createBitmap(10, 10, ARGB_8888);
    RequestHandler.Result result =
        new RequestHandler.Result(original, MEMORY, 0);
    Request data = new Request.Builder(URI_1).build();
    try {
  ...
  public void transformDrawables() {
    ...
    Drawable original =
        new BitmapDrawable(Bitmap.createBitmap(10, 10, ARGB_8888));
  ...
  private static class TestableBitmapHunter extends BitmapHunter {
    TestableBitmapHunter(Picasso picasso, Dispatcher dispatcher,
                         PlatformLruCache cache, Action action) {
      this(picasso, dispatcher, cache, action, null);
    }

    TestableBitmapHunter(Picasso picasso, Dispatcher dispatcher,
                         PlatformLruCache cache, Action action, Bitmap result) {
    ...
    TestableBitmapHunter(Picasso picasso, Dispatcher dispatcher,
      ...
      super(picasso, dispatcher, cache, action,
            spy(new TestableRequestHandler(result, exception)));
    }
  }
  ...
  private static class OOMBitmapHunter extends BitmapHunter {
    OOMBitmapHunter(Picasso picasso, Dispatcher dispatcher,
                    PlatformLruCache cache, Action action) {
  ...
  private static class OOMRequestHandler extends TestableRequestHandler {
    OOMRequestHandler() { super(null, null); }
