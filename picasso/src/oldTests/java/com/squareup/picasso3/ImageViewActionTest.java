...
public void throwsErrorWithNullResult() {
	...
	ImageViewAction action = new ImageViewAction(mock(Picasso.class), target,
...
public void invokesTargetAndCallbackSuccessIfTargetIsNotNull() {
	...
	Picasso picasso = new Picasso(
		RuntimeEnvironment.application, dispatcher, UNUSED_CALL_FACTORY, null,
		cache, null, NO_TRANSFORMERS, NO_HANDLERS, NO_EVENT_LISTENERS,
...
@Test
public void
invokesTargetAndCallbackErrorIfTargetIsNotNullWithErrorResourceId() {
	ImageView target = mockImageViewTarget();
	Callback callback = mockCallback();
	Picasso mock = mock(Picasso.class);
	ImageViewAction request = new ImageViewAction(
		mock, target, null, null, RESOURCE_ID_1, false, callback);
...
public void invokesErrorIfTargetIsNotNullWithErrorDrawable() {
	...
	Picasso mock = mock(Picasso.class);
	ImageViewAction request = new ImageViewAction(
		mock, target, null, errorDrawable, 0, false, callback);
	Exception e = new RuntimeException();
