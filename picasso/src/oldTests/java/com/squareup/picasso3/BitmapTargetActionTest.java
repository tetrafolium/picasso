...
public void invokesOnBitmapFailedIfTargetIsNotNullWithErrorDrawable() {
	...
	BitmapTargetAction request = new BitmapTargetAction(
		mock(Picasso.class), target, null, errorDrawable, 0);
...
public void invokesOnBitmapFailedIfTargetIsNotNullWithErrorResourceId() {
	...
	Picasso picasso =
		new Picasso(context, dispatcher, UNUSED_CALL_FACTORY, null, cache, null,
		            NO_TRANSFORMERS, NO_HANDLERS, NO_EVENT_LISTENERS, ARGB_8888,
		            false, false);
	Resources res = mock(Resources.class);
	BitmapTargetAction request =
		new BitmapTargetAction(picasso, target, null, null, RESOURCE_ID_1);
