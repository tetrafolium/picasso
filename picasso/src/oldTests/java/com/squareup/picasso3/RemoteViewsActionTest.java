...
public class RemoteViewsActionTest {
  ...
  private TestableRemoteViewsAction createAction(int errorResId,
    ...
    return new TestableRemoteViewsAction(picasso, null, errorResId,
                                         new RemoteViewsTarget(remoteViews, 1),
                                         callback);
  }
  ...
  private Picasso createPicasso() {
    ...
    return new Picasso(RuntimeEnvironment.application, dispatcher,
                       UNUSED_CALL_FACTORY, null, cache, null, NO_TRANSFORMERS,
                       NO_HANDLERS, NO_EVENT_LISTENERS, ARGB_8888, false,
                       false);
  }

  static class TestableRemoteViewsAction extends RemoteViewsAction {
    TestableRemoteViewsAction(Picasso picasso, Request data,
