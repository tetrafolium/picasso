...
// The use of ALPHA_8 simplifies the size math in tests since only one byte is
// used per-pixel.
...
private void assertSnapshot(PlatformLruCache cache, Object... keysAndValues) {
	...
	for (Map.Entry<String, PlatformLruCache.BitmapAndSize> entry :
	     cache.cache.snapshot().entrySet()) {
